...
const columns = [
    ...
    { label: 'Checklist', fieldName: 'Checklist__c', type: 'boolean', editable: true},
    {
...
export default class LWCDatatableWithPicklist extends LightningElement {
    columns = columns;
    showSpinner = false;
    @track data = [];
    @track accountData;
    ...
    wirePickList({ error, data }) {
        if (data) {
            ...
            console.log('print picklist value',this.pickListOptions);
        } else if (error) {
            console.log(error);
        }
    }
